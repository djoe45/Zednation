...
/*
	...
	Ported the code (DayZ Standalone) to DayZ mod for Arma 3 - SteelRat ( ProjectTeam )

*/

//_buildings = nearestObjects [(vehicle player), ["Building"],50];
_buildings = nearestObjects [(vehicle player), ["House_F"],50];
_isOk = true;
_i = 0;
