...
//	player_ReammoMagazines =	compile preprocessFileLineNumbers "\z\addons\dayz_code\compile\player_ReammoMagazines.sqf";
	ptm_fnc_getInventory =		compile preprocessFileLineNumbers "\z\addons\dayz_code\compile\fn_getInventory.sqf";
	PTm_fnc_filterGear =		compile preprocessFileLineNumbers "\z\addons\dayz_code\compile\fn_filterGear.sqf";
	PTm_fnc_getMagazinesEmpty = compile preprocessFileLineNumbers "\z\addons\dayz_code\compile\fn_getMagazinesEmpty.sqf";
	HandFlashLight_monitor =	compile preprocessFileLineNumbers "\z\addons\dayz_code\system\HandFlashLight_monitor.sqf";
	maniken_gearSync =			compile preprocessFileLineNumbers "\z\addons\dayz_code\compile\maniken_gearSync.sqf";
	player_addEventHandlers =	compile preprocessFileLineNumbers "\z\addons\dayz_code\init\player_addEventHandlers.sqf";
//	player_ObjectInBuildingCheck = compile preprocessFileLineNumbers "\z\addons\dayz_code\compile\player_ObjectInBuildingCheck.sqf";
	MP_say =					compile preprocessFileLineNumbers "\z\addons\dayz_code\compile\say.sqf";
	MP_SwitchMove =				compile preprocessFileLineNumbers "\z\addons\dayz_code\compile\switchmove.sqf";
	MP_PlayMove =				compile preprocessFileLineNumbers "\z\addons\dayz_code\compile\PlayMove.sqf";
//	BIS_Effects_Burn = 			compile preprocessFile "\ca\Data\ParticleEffects\SCRIPTS\destruction\burn.sqf"; 
	...
	electronics_build =			compile preprocessFileLineNumbers "\z\addons\dayz_code\actions\Electronics_build.sqf";
...
//	onPreloadFinished 			"dayz_preloadFinished = true;";
	...
	[] spawn {
		...
		_timeOut = 0;		
		dayz_loadScreenMsg = localize "STR_InitializingDAYZMOD";
		_ctrlText = "";
	...
	// 120 sec timeout
		while { _timeOut < 12000 && !dayz_clientPreload } do {
			if (!isNil "_display") then {
		...
		if ( !dayz_clientPreload ) then {
			...
			_control1 ctrlSetText format["%1",localize "STR_InitializingDAYZMODEND"];
...
//	fnc_ManikenAddItems =		compile preprocessFileLineNumbers "\z\addons\dayz_code\compile\fn_ManikenAddItems.sqf";
//	maniken_gearSyncMP =		compile preprocessFileLineNumbers "\z\addons\dayz_code\compile\maniken_gearSyncMP.sqf";
	...
	player_keyhandler = 		compile preprocessFileLineNumbers "\z\addons\dayz_code\compile\player_keyhandler.sqf";
	dz_fnc_jumpFnc = 			compile preprocessFileLineNumbers "\z\addons\dayz_code\actions\dz_fnc_jumpFnc.sqf";
