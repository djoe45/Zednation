...
nul = [] spawn server_spawnCrashSite; // Start spawn heli crash logic

nul_2 = [] spawn server_VehiclesSpawner; // Start spawn vehicle logic

nul_3 = [] spawn server_objectSpawner; //Start spawn object in map